...
class page_Worker:
    def __init__(self, window):
        ...
        title_frame = Label(frame_worker, text="Admin Functions",font=("Impact",28), fg="lightgray", bg="#5780B6")
        title_frame.place(x=110, y=30)
        
        # =========================================  SCAN BUTTON  =============================================
        scan_btn = Button(frame_worker, text="Manage Workers", command=self.manage_user, fg="black", bg="lightgray", activebackground="#5780B6",activeforeground="white", font=("times new roman", 20))
