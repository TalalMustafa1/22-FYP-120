...
class page_Reports:
    def __init__(self,window):
        self.window = window
        self.window.title("Report Details")
        ...
        self.txt_delete = Button(Frame_table, text='Delete Reports', command=self.WorkerDelete_Func, fg="black", bg="lightgray", activebackground="#5780B6",activeforeground="white", font=("Goudy", 14), cursor='hand2')
        self.txt_delete.place(x=170, y=430, width=140,height=40)
    ...
    def WorkerDelete_Func(self):
        import delete_reports
